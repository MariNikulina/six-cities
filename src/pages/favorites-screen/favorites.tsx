...
function FavoritesScreen ({offers}: MainPageProps): JSX.Element {
        ...
        <div className="page__favorites-container container">
          <section className="favorites">
            ...
            <ul className="favorites__list">
              ...
              {Object.entries(groupedOffersByCities).map(([city, offersList]) =>
                (<li key={city} className="favorites__locations-items">
                  ...
                  <div className="favorites__places">
                    {offersList.map((offer: OfferCard) =>
                      (<Card
                        key={offer.id}
                        offer={offer}
                        onMouseLeave={() => void 0}
                        onMouseMove={() => void 0}
                        classNames={FavoritesClassName}
                      />)
                    )}
                  </div>
                </li>)
